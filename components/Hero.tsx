        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            <Reveal>
                ...
                2,483 Drivers saved money today
                </div>
                ...
                Our AI-driven engine compares 100+ top-rated carriers in seconds. Stop overpaying and start saving an average of <strong>$620/year</strong> with better coverage.
                </p>
                
                <div className="hidden lg:flex flex-wrap gap-x-8 gap-y-4">
                <div className="flex items-center gap-3 text-brand-200 text-sm font-medium">
                    <div className="p-1 rounded-full bg-action-500/20 text-action-400"><CheckCircle2 size={16} /></div>
                    <span>Data Privacy Guarantee</span>
                </div>
                <div className="flex items-center gap-3 text-brand-200 text-sm font-medium">
                    <div className="p-1 rounded-full bg-action-500/20 text-action-400"><ShieldCheck size={16} /></div>
                    <span>Licensed State Partners</span>
                </div>
                <div className="flex items-center gap-3 text-brand-200 text-sm font-medium">
                    <div className="p-1 rounded-full bg-action-500/20 text-action-400"><Users size={16} /></div>
                    <span>5M+ Quotes Delivered</span>
                </div>
                </div>
            </Reveal>
          </div>
                ...
                <div id="get-quote" className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-1 border border-white/20 relative overflow-hidden group">
                    ...
                    <div className="bg-white rounded-xl p-6 md:p-8">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <h3 className="text-2xl font-display font-bold text-brand-900">Get Your Rates</h3>
                                <p className="text-slate-500 text-sm mt-1">Free quote. No SSN required.</p>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-start gap-3 pt-2">
                                ...
                                <p className="text-[10px] text-slate-500 leading-relaxed">
                                    By clicking "Show My Rates", I authorize QuickCover and its <a href="#" className="underline decoration-slate-300 hover:text-primary-600">partners</a> to contact me via automated technology. I agree to the <a href="#" className="underline decoration-slate-300 hover:text-primary-600">Privacy Policy</a>.
                                </p>
                            </div>
